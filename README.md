...
This will install all required packages and locally host the project using http-server. Navigate to the URL output by http-server (usually `127.0.0.1:8080`) *in the /dist folder* (`127.0.0.1:8080/dist`) using a chromium web browser.

## Notes and Issues
- Rendering is highly distorted from close distances. This bug is still being worked out.
